...
open class Funcionario(val nome:String, val idade:Int){
    init {
        println("O funcionário $nome foi cadastrado com $idade anos.")
    }
...
fun main() {
    class Gerente(nome: String="", idade: Int=18, var setor: String="") : Funcionario(nome, idade)

    class Desenvolvedor(nome: String="", idade: Int=18, var linguagem: String="") : Funcionario(nome, idade)

    class Analista(nome: String="", idade: Int=18, var area: String="") : Funcionario(nome, idade)

    val gerente = Gerente("João", 32, "TI")
    val desenvolvedor = Desenvolvedor("Simon", 22, "PHP")
    val analista = Analista("Henrique", 26, "Sistemas")

    print("Setor: ${gerente.setor}, ")
    gerente.Apresentar()

    print("Linguagem: ${desenvolvedor.linguagem}, ")
    desenvolvedor.Apresentar()

    print("Área: ${analista.area}, ")
    analista.Apresentar()
}